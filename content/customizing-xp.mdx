...
The XP Formula specifies how levels will be determined. By default, Kiai uses the formula `12 * ({level} * {level}) + {level} * 12`, which can be visualized at https://go.kiai.app/visualizer.
