...
XP Streaks can be enabled in `/settings > XP Streaks` and set to send in a specific channel. Advanced configuration of XP Streaks is only avaliable to premium guilds.
