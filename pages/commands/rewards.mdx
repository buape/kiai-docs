...
You also have the option of setting a length of time that the user has the role before the bot removes it again. This can be used in, for example, setups where you want a level to have a temporary [multiplier](/commands/multiplier) through a role.
