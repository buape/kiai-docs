...
You can change this formula to whatever you want using the `/custom-formula` command. Custom formulas must include the `level` placeholder which will be replaced. For more information on the `/custom-formula` command, see the Commands section.